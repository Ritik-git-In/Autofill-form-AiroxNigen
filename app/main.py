...
from .extraction import parse_pdf_pages, parse_pdf_page_range_detailed, extract_profile, parse_reference_document
...
from .generator import build_verbatim_document, slugify
        ...
        for value in selected:
            if value.startswith("gen:"):
                ...
                build_verbatim_document(
                    ...
                    load_company_profile(), values["signing_date"], values["signing_place"],
                )
